...
- 🚀 **本地图片一键复制** - **核心特性**：完美支持本地图片（包括 Wiki Links `![[Image]]`），复制时自动压缩并转换为 Base64 嵌入，彻底告别图床烦恼
- 💻 **Mac 风格代码块** - 支持 macOS 窗口风格代码块，可选显示行号
- 📱 **实时预览** - 支持**所见即所得**的实时预览，智能防抖渲染，流畅无卡顿
...
2. **自动转换**
   ...
   - **支持图片格式**：标准 Markdown `![](image.png)` 或 Obsidian 双链 `![[image.png]]` 均可完美识别
   - 在右侧预览区即可看到排版后的效果
...
3. **调整与复制**
   ...
   - 点击底部的 **[📋 复制到公众号]** 按钮
     - *提示*：如果包含本地图片，插件会自动进行**智能压缩与转码**，请耐心等待 1-2 秒处理完成
   - 粘贴到微信公众号后台编辑器即可
...
- **UI 优化**：引用块边框与背景色会自动跟随主题色，保持视觉一致性

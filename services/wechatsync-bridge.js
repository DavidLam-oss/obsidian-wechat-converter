...
实现浏览器发布助手桥接的 wechatsync bridge 能力。
...
输出 `DEFAULT_WECHATSYNC_PORT`、`DEFAULT_SYNC_REQUEST_TIMEOUT_MS`、`DEFAULT_HELLO_TIMEOUT_MS`、`LOCAL_BIND_HOST`、`REMOTE_BIND_HOST`、`HELLO_ERROR_TOKEN_MISMATCH`、`HELLO_ERROR_INVALID_PAYLOAD`、`HELLO_ERROR_TIMEOUT`、`HELLO_ERROR_VERSION_UNSUPPORTED`、`HELLO_ERROR_DUPLICATE_SESSION`，用于桥接调用、结果归一化和平台状态展示。
